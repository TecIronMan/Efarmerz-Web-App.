...
<form action="login.jsp" style="width:300px;" class="f ">
  <h1 class="title" style="left:40%; padding: 30px;">Farmer Login</h1>
...
<div class="b">
 ...
 <div class="forgot">  
                     <a style="color: red;" href="verifyusername.jsp"> Forgot Password? </a>  
                </div>
   
</div>

                <div class="sign-up">  
                    Don't have an account? <a href="farmerregister.jsp"> Create One </a>  
                </div>
</form>
