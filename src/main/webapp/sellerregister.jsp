  ...
  <h2 class="title" style="left:50%;  padding-top: 80px;">Registration</h2>
    ...
    <div class="mb-3">
     ...
     <div class="mb-3">
      ...
      <div class="mb-3">
          <input type="text" class="form-control" required="required"name="MobileNo" placeholder="Mobile no">
          <span style="color: red;">${error4}</span>
      </div>
      <div class="mb-3">
          <input type="email" class="form-control" required="required" name="email" placeholder="E-mail Id">
      ...
      <div class="mb-3">
       ...
       <div class="mb-3">
          <input type="password" class="form-control" required="required" name="pass1" placeholder="Confirm Password">
    ...
    Already Resister?<a href="seller.jsp">Login</a>
    </div>
</form>
</body>
</html>
