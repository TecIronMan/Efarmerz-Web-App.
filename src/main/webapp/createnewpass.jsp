  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="nav-item dropdown" style="padding-right: 30px; font-size: 20px; ">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown" >
          ...
          <a class="dropdown-item" href="/sellerlogin">Wholesaler</a>
...
<form action="updatepass.jsp" style="width:400px;" class="f ">
  <h1 class="title" style="left:40%; padding: 30px;">Create Password</h1>

<label for="exampleInputEmail1" class="form-label">Enter Password</label>
<input type="password" class="form-control" required="required" name="pass1">
<span style="color: red;">${error2}</span>


<label for="exampleInputPassword1" class="form-label">Confirm-Password</label>
<input type="password" class="form-control" required="required" name="pass2" >
 <span style="color: red;">${error1}</span>

    <input type="hidden" value="1" name="status" />
<div class="b">
 <button type="submit" class="btn btn-info " style="margin-left: 60px;">Update Password</button>
