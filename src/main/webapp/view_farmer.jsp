...
<html>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto" style="font-size: 20px;">
        ...
        <li>
        <a class="nav-link" style="color: black;  text-decoration: underline;"  href="view_farmer.jsp">View Farmer</a>
      </li>
      <li >
                   ...
                   <center><h3><font style="font-size: 40px;  color: #2cadff; ">Complains</font></h3>
                    <table border="2" style="text-align: center;margin-top: 50px; ">
                        ...
                        <tr >
                            ...
                            <td class="bor" style="color: #4CAF50; font-size: 16px"><a href="delete.jsp?id=<%=rs.getString("id")%>&status=1"><font style="color: green">Delete</a></td>	
