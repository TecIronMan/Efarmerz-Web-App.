...
<form action="verifyotp.jsp" style="width:300px;" class="f ">
  <h1 class="title" style="left:40%; padding: 30px;">Verify OTP</h1>
...
<div class="b">
 <button type="submit" class="btn btn-info " style="margin-left: 60px;">Verify</button>
