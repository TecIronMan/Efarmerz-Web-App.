...
<form action="login.jsp" style="width:300px;" class="f ">
  <h1 class="title" style="left:40%; padding: 30px; color: #8ee8c1;margin-top: 80px;">Wholesaler Login</h1>
...
<div class="b">
<button type="submit" class="btn btn-info " style="margin-left: 60px;">Login</button>
 <div class="forgot">  
                     <a style="color: red;" href="verifyselleremail.jsp"> Forgot Password? </a>  
                </div>
   
</div>

                <div class="sign-up" style="color: grey;">  
                    Don't have an account? <a href="sellerregister.jsp" style="color: red;"> Create One </a>  
                </div>
</body>
</html>
