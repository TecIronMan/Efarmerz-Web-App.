...
<html>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto" style="font-size: 20px;">
      ...
      <li>
        <a class="nav-link" style="color: black;  text-decoration: underline;" href="farmertips.jsp">Farming Tips</a>
      </li>
      <li>
	  ...
	  <br><br><br><br><br>
  <center>  <form action="posttip.jsp" style="border: 1px solid black; width: 400px; height: 300px"><br><br><br>
          Farming Tip:&nbsp;&nbsp;<input type="text" name="tip" placeholder=" Write Tip Here..." style="height: 70px; width: 270px"><br><br><br>
