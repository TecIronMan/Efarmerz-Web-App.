  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto" style="font-size: 20px;">
       ...
       <li>
        ...
        <li>
        <a class="nav-link"style="color: black;  text-decoration: underline;" href="farmingtips.jsp">Farming Tips</a>
      </li>
        <li>
                   ...
                   <center><h3><font style="font-size: 40px;  color: #2cadff ">File Details</font></h3>
                    <table border="2" style="text-align: center;margin-top: 50px; width: 400px; ">
                        <tr style="height: 50px; ">
                            <th class="bor" style="text-align: center;width: 150px; color: black; font-size: 18px; ">Farming Tips</th>
                        ...
                        <%
                            ...
                            try {
                                ...
                                rs = st.executeQuery("select * from farmertips");
                                while (rs.next()) {

                        %>
                        <tr >
                            <td class="bor" style="color: midnightblue; font-size: 16px"><%=rs.getString("tips")%></td>
